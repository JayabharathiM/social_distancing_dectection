...
def reg():
    ...
    imgX=ImageTk.PhotoImage(Image.open(r"C:/Users/hp/AppData/Local/Programs/Python/Python36/Social-distance-detection-master/UI-Images/ss.jpg"))
    lpicX=Label(treg)
    ...
    bZ=Button(treg,text="BACK",font="bold 20",command=bck)
...
def login():           
    ...
    my=mydb.cursor()
    my.execute("use kunal")
    my.execute("select * from data where user_id='" + l1 + "' and user_pin='" + l2 + "'")
    res=my.fetchall()
    count=0
    for x in res:
        ...
        imgl=ImageTk.PhotoImage(Image.open(r"C:/Users/hp/AppData/Local/Programs/Python/Python36/Social-distance-detection-master/UI-Images/ss.jpg"))
...
img2=ImageTk.PhotoImage(Image.open(r"C:/Users/hp/AppData/Local/Programs/Python/Python36/Social-distance-detection-master/UI-Images/x3.jpg"))
lpic2=Label(t,image=img2)
lpic2.place(x=0,y=0)
def a():
    global count
    img2=ImageTk.PhotoImage(Image.open(r"C:/Users/hp/AppData/Local/Programs/Python/Python36/Social-distance-detection-master/UI-Images/x"+str(count)+".jpg"))
...
luser=Label(t,text="Username",font="bold 15")
luser.place(x=380,y=500)
lpass=Label(t,text="Password",font="bold 15")
lpass.place(x=780,y=500)
t1=Entry(t,font="bold 15")
t1.place(x=520,y=500)
t2=Entry(t,show="*",font="bold 15")
t2.place(x=910,y=500)
b1=Button(t,text="Register",font="bold 15",command=reg,relief=RAISED)
b2=Button(t,text="Login",font="bold 15",command=login,relief=SUNKEN)
